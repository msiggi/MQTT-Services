...
public class Worker : IHostedService
{
    ...
    private readonly IRemoteCallRequester<GuitarPlayer> remoteServiceRequester;

    public Worker(ILogger<Worker> logger, IRemoteCallRequester<GuitarPlayer> remoteServiceRequester)
    {
        this.logger = logger;
    ...
    private void RemoteServiceRequester_AllItemsResponseReceived(object? sender, List<GuitarPlayer> e)
    {
